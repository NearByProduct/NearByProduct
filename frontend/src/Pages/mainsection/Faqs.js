    ...
    <Fragment>
      <div className="container my-24 mx-auto md:px-6 xl:px-24">
        <section className="mb-32">
          <h2 className="mb-6 pl-6 text-3xl font-bold text-black">
            Frequently asked questions
          </h2>

          <div id="accordionFlushExample">
            {faqData &&
              faqData.map((data, index) => <Faq key={index} data={data} />)}
          </div>
        </section>
      </div>
    </Fragment>
  ...
  return (
    <div className="rounded-none border border-t-0 border-l-0 border-r-0 border-neutral-200">
      <h2 className="mb-0" id="flush-headingOne">
        ...
        >
          {data.question}
          <span className="ml-auto h-5 w-5 shrink-0 rotate-[-180deg] fill-[#336dec] transition-transform duration-200 ease-in-out [!open]:rotate-0 [!open]:fill-[#212529] motion-reduce:transition-none dark:[!open]:fill-[#8FAEE0] dark:[!open]:fill-[#eee]">
